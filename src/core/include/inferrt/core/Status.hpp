...
enum class Status : int8_t
{
    ...
    // Keep C++ enumerator names distinct from Windows SDK ERROR_* macros.
    INVALID_OPERATION       = IRT_ERROR_INVALID_OPERATION,
    ERROR_DEVICE            = IRT_ERROR_DEVICE,
    NOT_READY               = IRT_ERROR_NOT_READY,
    ERROR_OUT_OF_MEMORY     = IRT_ERROR_OUT_OF_MEMORY,
    ERROR_INTERNAL          = IRT_ERROR_INTERNAL,
    UNKNOWN                 = IRT_ERROR_UNKNOWN
};
