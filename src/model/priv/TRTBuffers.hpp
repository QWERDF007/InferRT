...
public:
    ...
    {
        return irt::checkedSizeMul(size_, irt::model::elementSize(data_type_), "TensorRT buffer bytes");
    }
...
private:
    void reallocate(size_t new_capacity, nvinfer1::DataType data_type)
    {
        ...
        const auto bytes    = irt::checkedSizeMul(new_capacity, irt::model::elementSize(data_type),
                                                   "TensorRT buffer bytes");
