...
void buildResNet(nvinfer1::INetworkDefinition *network, const WeightsMap &weights_map, const std::array<int, 4> &layers,
                 int expansion, BlockBuilder block)
{
    using namespace nvinfer1;
    constexpr int N = 1;
    ...
    avgpool->setStrideNd(DimsHW{1, 1});
